...
TEXT: dict[str, dict[str, str]] = {
    ...
    "host_group_hint": {"en": "Only hosts linked into that group are offered.",
                        "ja": "そのグループにリンクされたホストのみ選択できます。"},
    "dialog_choose": {"en": "Choose where this run executes",
                      "ja": "この実行の実行先を選択"},
    "dialog_use": {"en": "Use this host", "ja": "このホストを使用"},
    "dialog_cancel": {"en": "Cancel", "ja": "キャンセル"},
    "no_hosts": {"en": "No hosts are linked to “@@”.",
                 "ja": "「@@」にリンクされたホストがありません。"},
    "no_groups": {"en": "No host groups exist in this workspace.",
                  "ja": "このワークスペースにホストグループがありません。"},
    "host_chosen": {"en": "Running on “@@”", "ja": "実行先：「@@」"},
    "err_no_host_group": {"en": "Choose a host group before creating the Operation.",
                          "ja": "オペレーション作成前にホストグループを選択してください。"},
    "err_host_offered": {"en": "“@@” is not a host in the group you chose.",
                         "ja": "選択したグループにホスト「@@」はありません。"},
    "err_no_host": {"en": "Choose a host in “@@”.",
                    "ja": "「@@」内のホストを選択してください。"},
    ...
    "step_param_sheet": {"en": "Create Parameter Sheet '{name}'",
                         "ja": "パラメータシートを作成 '{name}'"},
    "step_operation": {"en": "Create Operation '{name}'",
                       "ja": "オペレーション「{name}」を作成"},
    "step_input": {"en": "Create Input row on host '{name}'",
                   "ja": "ホスト「{name}」へ入力データを作成"},
    ...
    "adv_operation_menu": {"en": "Operation menu", "ja": "オペレーション管理メニュー名"},
